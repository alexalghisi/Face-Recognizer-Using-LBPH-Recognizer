...
takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="green", width=20, height=3,
                    activebackground="Red", font=('times', 20, 'italic bold '))
takeImg.place(x=200, y=500)

training = tk.Button(window, text="Train Images", fg="black", command=training, bg="green", width=20, height=3,
                     activebackground="Red", font=('times', 20, 'italic bold '))
training.place(x=590, y=500)
